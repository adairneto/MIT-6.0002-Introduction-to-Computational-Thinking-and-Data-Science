...
class Digraph(object):
    ...
    def add_node(self, node):
        ...
        # pass  # TODO
        if node not in self.edges: # Evaluates if the node is already in the graph
            self.nodes.add(node)
            self.edges[node] = [] # If not, then add to the graph with empty edges
        else:
    ...
    def add_edge(self, edge):
        ...
        # If either of the nodes associated is not in the graph
